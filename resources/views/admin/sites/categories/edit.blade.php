...
<div class="card">
    <div class="card-body">
        <form method="POST" action="{{ route('admin.sites.categories.update', $category) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                ...
                <div class="col-md-8">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text"
                               ...
                               required>
                        <div class="form-text">Будет использован в URL: /sites/category/<strong id="slug-preview">{{ $category->slug }}</strong></div>
                        @error('slug')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="card bg-light">
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mb-0">
                                <li><i class="bi bi-globe me-2"></i>Сайтов: <strong>{{ $category->approvedSitesCount() }}</strong></li>
