...
<div class="row mb-3">
    <div class="col-md-12">
        <div class="d-flex justify-content-between align-items-center">
            <h2>Категории каталога сайтов</h2>
            <a href="{{ route('admin.sites.categories.create') }}" class="btn btn-primary">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr class="table-light">
                        ...
                        <td>
                            <span class="badge bg-info">{{ $category->approvedSitesCount() }}</span>
                        </td>
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                <a href="{{ route('admin.sites.categories.edit', $category) }}"
                                   class="btn btn-sm btn-outline-primary" title="Редактировать">
                                    <i class="bi bi-pencil"></i>
                                </a>
                                <form id="delete-category-{{ $category->id }}" method="POST"
                                      action="{{ route('admin.sites.categories.destroy', $category) }}" class="d-none">
                                    @csrf
                                    @method('DELETE')
                                </form>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge bg-info">{{ $child->approvedSitesCount() }}</span>
                        </td>
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                <a href="{{ route('admin.sites.categories.edit', $child) }}"
                                   class="btn btn-sm btn-outline-primary" title="Редактировать">
                                    <i class="bi bi-pencil"></i>
                                </a>
                                <form id="delete-subcategory-{{ $child->id }}" method="POST"
                                      action="{{ route('admin.sites.categories.destroy', $child) }}" class="d-none">
                                    @csrf
                                    @method('DELETE')
                                </form>
                                <button type="button" class="btn btn-sm btn-outline-danger" title="Удалить"
                    ...
                    <tr>
                        <td colspan="8" class="text-center py-4">
                            ...
                            <a href="{{ route('admin.sites.categories.create') }}" class="btn btn-primary mt-2">
